...
class Track_ : Parcelable {
    ...
    companion object CREATOR : Parcelable.Creator<Track_> {
        override fun createFromParcel(parcel: Parcel): Track_ {
            return Track_(parcel)
        }

        override fun newArray(size: Int): Array<Track_?> {
